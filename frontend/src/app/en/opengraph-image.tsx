...
export const alt = "Actuarius — Actuarial reserving and IBNR platform";

/** İngilizce paylaşım kartı. Build sırasında üretilir. */
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ fontSize: 27, color: "#5d6472", marginTop: 22, lineHeight: 1.4 }}>
            Data · Reserving · Cash Flow · Discounting — with an AI agent across all
          </div>
        </div>
