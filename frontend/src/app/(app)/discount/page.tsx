        ...
        <table className="w-full text-xs">
          <thead>
            <tr style={{ background: "var(--surface-alt)" }}>
              ...
              <th className="px-4 py-2.5 text-right font-medium text-[color:var(--muted-strong)]">Duration (ay)</th>
          ...
          <tbody>
            {result.origins.map((o, i) => (
              ...
              >
                ...
                <td className="px-4 py-2 text-right font-mono">{o.duration.toFixed(1)}</td>
          ...
          <tfoot>
            <tr className="border-t-2 font-semibold" style={{ borderColor: "var(--border)", background: "var(--surface)" }}>
              ...
              <td className="px-4 py-3 text-right font-mono">{result.totals.duration.toFixed(1)}</td>
      ...
      {origin && (
        <div className="flex gap-3 flex-wrap">
          {[
            ...
            { label: "Duration", value: `${origin.duration.toFixed(1)} ay`, color: "var(--muted-strong)" },
          ].map((s) => (
            <div
              key={s.label}
